...
import { ArrowLeft, Upload, FileText, Unlock, AlertTriangle } from "lucide-react";
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-lg font-semibold">Unlock PDF</h1>
            </div>
            ...
            <div className="border rounded-xl p-4 mb-4 bg-amber-50/50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800">
                <div className="flex gap-3">
                    ...
                    <div className="text-sm text-muted-foreground">
                        ...
                        <p>PDF decryption requires specialized libraries that aren't available in browser environments for security reasons.</p>
                        <p className="mt-2">To unlock a protected PDF, use:</p>
                        <ul className="list-disc list-inside mt-1 space-y-1">
                            <li>Adobe Acrobat Pro</li>
                            <li>PDF24 Tools (desktop)</li>
                            <li>qpdf (command line)</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            {!file ? (
                ...
                >
                    ...
                    <p className="text-sm"><span className="font-medium">Drop protected PDF</span></p>
                </div>
            ) : (
            ...
            <p className="text-xs text-muted-foreground text-center mt-6">Use desktop tools for PDF decryption</p>
        </div>
    );
}
